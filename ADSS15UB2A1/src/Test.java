...
//		Punkt bz = new Punkt(30,30,30);
		...
		System.out.println("Durchmesser: " + k1.durchmesser() + " Oberflaeche: " + k1.oberflaeche() + " Volumen: " + k1.volumen());
		System.out.println("Durchmesser: " + k2.durchmesser() + " Oberflaeche: " + k2.oberflaeche() + " Volumen: " + k2.volumen());
